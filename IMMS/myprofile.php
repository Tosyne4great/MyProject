...
$sql="update tblemployees set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Subunit=:subunit,Address=:address,Position_type=:position_type,Phonenumber=:mobileno where EmailId=:eid";
...
<label for="email">Subunit</label>
<input  name="subunit" type="text" id="subunit" value="<?php echo htmlentities($result->Subunit);?>" readonly autocomplete="off" required>
</div>
</div>

<div class="input-field col s6">
<label for="email">Staff position</label>
<input  name="position_type" type="text" id="position_type" value="<?php echo htmlentities($result->Position_type);?>" readonly autocomplete="off" required>
</div>

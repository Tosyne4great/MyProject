...
$query -> execute();
$msg="Staff position record deleted";
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Manage Staff Position</title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title">Manage Staff Position</div>
                    </div>

                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Staff Position Info</span>

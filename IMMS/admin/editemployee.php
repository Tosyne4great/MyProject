...
$sql="update tblemployees set EmpId=:emp,FirstName=:fname,LastName=:lname,Gender=:gender,Supervisor=:supervisor,Subunit=:subunit,Address=:address,Position_type=:position_type,Phonenumber=:mobileno where id=:eid";
...
<div class="input-field col m6 s12">
<select  name="supervisor" autocomplete="off">
<option value="<?php echo htmlentities($result->Supervisor);?>"><?php echo htmlentities($result->Supervisor);?></option>
...
<option value="<?php echo htmlentities($result->Subunit);?>"><?php echo htmlentities($result->Subunit);?></option>
...
{   ?>
<option value="<?php echo htmlentities($resultt->subunit_name);?>"><?php echo htmlentities($resultt->subunit_name);?></option>
<?php }} ?>
</select>
</div>
...
foreach($results as $resultt)
{   ?>
<option value="<?php echo htmlentities($resultt->position_type);?>"><?php echo htmlentities($resultt->position_type);?></option>
<?php }} ?>
</select>
</div>

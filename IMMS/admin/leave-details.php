...
date_default_timezone_set('Asia/Kolkata');
$admremarkdate=date('Y-m-d G:i:s ', strtotime("now"));
$sql="update tblleaves set Status=:status,AdminRemarkDate=:admremarkdate where id=:did";
$query = $dbh->prepare($sql);
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Admin | Form Details </title>
    ...
    <body>
       ...
       <?php include('includes/sidebar.php');?>
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title" style="font-size:24px;">Form Details</div>
                    </div>
...
$sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.Subunit,tblemployees.id,tblemployees.Gender,tblemployees.Phonenumber,tblemployees.EmailId,tblleaves.Position_type,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Task,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblemployees on tblleaves.empid=tblemployees.id where tblleaves.id=:lid";
$query = $dbh -> prepare($sql);
      ...
      ?>
                                        ...
                                        <tr>
                                          ...
                                          <tr>
                                            ...
                                            <td style="font-size:16px;"><b>Subunit :</b></td>
                                           <td><?php echo htmlentities($result->Subunit);?></td>
                                        </tr>

  <tr>
                                             <td style="font-size:16px;"><b>Position :</b></td>
                                            <td><?php echo htmlentities($result->Position_type);?></td>
                                             <td style="font-size:16px;"><b>Form Date :</b></td>
...
<tr>
                                             <td style="font-size:16px;"><b>Task : </b></td>
                                            <td colspan="5"><?php echo htmlentities($result->Task);?></td>

                                        </tr>

<tr>
<td style="font-size:16px;"><b>Form Status :</b></td>
...
<tr>
<td style="font-size:16px;"><b>Supervisor's Comment : </b></td>
<td colspan="5"><?php

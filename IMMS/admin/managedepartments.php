                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <span class="card-title">Department Info</span>
...
{               ?>
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->subunit_name);?></td>
                                            <td><?php echo htmlentities($result->subunit_short_name);?></td>

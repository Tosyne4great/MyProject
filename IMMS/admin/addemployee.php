...
$sql="INSERT IGNORE INTO tblemployees(EmpId,FirstName,LastName,EmailId,Password,Gender,Supervisor,Subunit,Address,Position_type,Phonenumber,Status)
      VALUES(:empid,:fname,:lname,:email,:password,:gender,:supervisor,:subunit,:address,:position_type,:mobileno,:status)";
